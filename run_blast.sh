...
blastn -db  "$db_fasta_base".DB -query $db_fasta -outfmt '6 qseqid sseqid pident nident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen' -out $query_fasta_base\_vs_$db_fasta_base\_blastresults.txt
