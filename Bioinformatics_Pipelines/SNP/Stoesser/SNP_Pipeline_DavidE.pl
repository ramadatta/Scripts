...
# High Quality SNP as mentioned in ST131 Paper - Also ignore INDEL calling (takes time)
...
cp /storage/data/DATA4/analysis/2_CPE_Tranmission_SNP_pipeline/scripts/replace_RepeatNs_DE.pl DavidE_Method/replace_RepeatNs_DE.pl
cp /storage/data/DATA4/analysis/2_CPE_Tranmission_SNP_pipeline/scripts/generateInvariantSites.sh  DavidE_Method/generateInvariantSites.sh 
cp /storage/data/DATA4/analysis/2_CPE_Tranmission_SNP_pipeline/scripts/AppendInvariantSites.pl DavidE_Method/AppendInvariantSites.pl
cp /storage/data/DATA4/analysis/2_CPE_Tranmission_SNP_pipeline/scripts/BEAST_DatesHeader.pl DavidE_Method/BEAST_DatesHeader.pl
cp /storage/data/DATA4/analysis/2_CPE_Tranmission_SNP_pipeline/scripts/replaceAmbigousBases2N.pl DavidE_Method/replaceAmbigousBases2N.pl
