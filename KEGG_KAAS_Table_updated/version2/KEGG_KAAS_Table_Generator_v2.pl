...
##Dependencies: The folder running this script should also have the sister files GeneCount_Pathway_Table.txt,General_Pathways.txt				
##Script Author: Prakki Sai Rama Sridatta
##Date: December 13,2013
##Edited for update on: August 11,2015 
##Email: prakkisr@tll.org.sg // ramadatta.88@gmail.com
## Usage: perl KEGG_KAAS_Table_Generator_v2.pl <collapsed.txt> <query.ko>
###########################################################################################################################
...
print "Finished generating Process_Transcript_Enzyme_Kegg_pathway.txt file1, STEP3 OUT OF STEP6\n";
		...
		open GenCount,"$PWD/GeneCount_Pathway_Table.txt";
		%GeneCountHash=();
...
print "Finished generating Final_Specific_Table.txt file, STEP5 OUT OF STEP6\n";
		...
		open GEN,"$PWD/General_Pathways.txt";
		chomp(@gen=<GEN>);
